...
<head>
    ...
    <title>Agriculteur | {{$categorie->libelle}}</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    <h2>{{$categorie->libelle}}</h2> <!-- Affichage du nom de la catégorie -->
                </div>
                <div class="featured__controls">
                    <ul>
                        <!-- Vous pouvez ajouter des filtres ou des contrôles ici si nécessaire -->
                    </ul>
                </div>
            </div>
        </div>
        <div class="row featured__filter">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix {{ strtolower(str_replace(' ', '-', $produit->categorie->libelle)) }}">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="{{ asset('images/produits/'.$produit->photo1) }}">
                    ...
                    <div class="featured__item__text">
                        ...
                        <h6>{{ $produit->prix }}</h6>
                        <span><b>Type de vente :</b></span>
                        <div style="display: inline-flex; align-items: center;">
                            <span>{{ $produit->type_vente }}</span>
